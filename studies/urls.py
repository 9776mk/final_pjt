...
urlpatterns = [
    ...
    path(
        "<int:study_pk>/board/<int:article_pk>/update/",
        views.board_update,
        name="board_update",
    ),  # 스터디 게시판 글 수정
    path(
        "<int:study_pk>/board/<int:article_pk>/delete/",
        views.board_delete,
        name="board_delete",
    ),  # 스터디 게시판 글 삭제
    path(
        "<int:study_pk>/board/<int:article_pk>/comment/",
        views.comment_create,
        name="comment_create",
    ),  # 스터디 게시판 댓글 작성
    path(
        "<int:study_pk>/board/<int:article_pk>/comment/<int:comment_pk>/delete/",
